...
const (
	FORWARD MovementDirection = iota
	BACKWARD
	LEFT
	RIGHT
)
...
func (c *Camera) ProcessKeyboard(direction MovementDirection, deltaTime float32) {
...
func (c *Camera) ProcessMouseMovement(xoffset, yoffset float32, clampPitchToVertical bool) {
	xoffset *= 0.1
	yoffset *= 0.1
